# Assign Visual Studio licenses

Before provisioning the M365 sandbox, activate your Visual Studio Enterprise benefit in Partner Center and assign it to the lab user. The number of subscriptions you have depends on your Microsoft AI Cloud Partner Program tier — see the table below.
...
| Program | VS Enterprise subscriptions |
| --- | --- |
| Partner Launch | 1 |
...
| Designation | VS Enterprise subscriptions |
| --- | --- |
...
| Tier | VS Enterprise subscriptions |
| --- | --- |
| ISV Success Core | 25 |
...
| Specialization | VS Enterprise subscriptions |
| --- | --- |
| Azure | 10 |
